      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-16 js-about-animate">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-red-100 to-red-50 text-red-700 rounded-full mb-6">
            ...
            <span><EditableText slug="about_badge" defaultText="Who We Are" /></span>
          </div>
          <h2 className="text-5xl md:text-6xl mb-6 bg-linear-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">
            <EditableText slug="about_main_title" defaultText="About RCCG Living Spring" />
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            <EditableText slug="about_main_subtitle" defaultText="Living Spring is a vibrant, Spirit-filled parish of the Redeemed Christian Church of God, committed to raising champions who will dominate their generation for Christ." />
          </p>
        </div>
          ...
          {values.map((value, index) => {
            ...
            return (
              <div
                ...
                <h3 className="text-2xl mb-3 group-hover:text-red-700 transition-colors">
                  <EditableText slug={`about_value_${index}_title`} defaultText={value.title} />
                </h3>
                <p className="text-gray-600 leading-relaxed">
                  <EditableText slug={`about_value_${index}_desc`} defaultText={value.description} />
                </p>
              </div>
            );
          })}
          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-8 md:p-12 flex flex-col justify-center js-story-content">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-100 text-red-700 rounded-full mb-6 w-fit">
                ...
                <span><EditableText slug="about_story_badge" defaultText="Our Story" /></span>
              </div>
              <h3 className="text-4xl mb-6 bg-linear-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">
                <EditableText slug="about_story_title" defaultText="Living Spring" />
              </h3>
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  <EditableText slug="about_story_p1" defaultText="This church was started in March 2009 as a church planted by Living Spring Harrisburg. We had our first worship service at the Comfort Inn & Suites, York and held subsequent services at the nearby Homewood Suites." />
                </p>
                <p>
                  <EditableText slug="about_story_p2" defaultText="By September 2009, Pastor Sam Anyanwu took over as the first pastor. Before he left, the lord used him to take the church from meeting in the hotel to a more comfortable location at 2346B Carnegie Road at East York. Pastor Victor Johnsons pastored the church from January 2012 through February 2013." />
                </p>
                <p>
                  <EditableText slug="about_story_p3" defaultText="This transitionary period was a very difficult time for our church, due to the fluid nature of things. Membership declined significantly and morale was very low. But the Rock of Ages who never changes kept a remnant unto Himself. By the grace of God, this church rose from the ashes and blossomed and thrived to where it is today." />
                </p>
                <p>
                  <EditableText slug="about_story_p4" defaultText="We aim to be a family-friendly church where love is not just an idea but a principle that undergird all that we do. We want our meetings to be opportunities to meet with God and for God to meet with His people. Our church aims to be a place where members are baptized in the Holy Spirit and learn to walk in the Spirit all the days of their lives." />
                </p>
                <p>
                  <EditableText slug="about_story_p5" defaultText="We aim to be a church where freshly baked spiritual bread is distributed weekly to feed the sheep. This church is a refuge for sinners, hospital for the sick, miracle center for the needy and a haven of rest for the weary. We aim to develop a people who are Christ-centered and eternity-focused." />
                </p>
              </div>
            </div>
          </div>
