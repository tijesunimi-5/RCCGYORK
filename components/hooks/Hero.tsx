  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-20">
      ...
      >
        ...
        <div className="absolute inset-0 bg-linear-to-br from-indigo-950/90 via-indigo-900/80 to-black/80" />
      </div>
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto py-20">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          ...
          <Button
            size="lg"
            variant="outline"
            // Secondary Button: Red hover accent
